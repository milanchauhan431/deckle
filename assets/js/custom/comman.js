...
$(document).ready(function(){
	...
	$(document).on('click',".addNew",function(){
		...
		var api_slug = $(this).data("api_slug") || "";
		...
		var fnJson = "{'formId':'"+formId+"','controller':'"+controllerName+"','fnsave':'"+fnsave+"','api_slug':'"+api_slug+"','confirm_msg':'"+confirm_msg+"'}";
...
function edit(data){
	...
	var api_slug = data.api_slug;if(api_slug == "" || api_slug == null){api_slug="";}
	...
	var fnJson = "{'formId':'"+data.form_id+"','controller':'"+controllerName+"','fnsave':'"+fnsave+"','api_slug':'"+api_slug+"','confirm_msg':'"+(data.confirm_msg || "")+"'}";
